...
TEST(Float3, Normalized) {
  ...
  EXPECT_FLOAT_EQ(normalized.x(), 0.57735026f);
  EXPECT_FLOAT_EQ(normalized.y(), 0.57735026f);
  EXPECT_FLOAT_EQ(normalized.z(), 0.57735026f);
}
...
TEST(Float3, SubtractByFloat) {
  ...
  EXPECT_FLOAT_EQ(c.x(), .0f);
  EXPECT_FLOAT_EQ(c.y(), .0f);
  EXPECT_FLOAT_EQ(c.z(), .0f);
}
